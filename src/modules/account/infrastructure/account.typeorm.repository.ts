...
const TypeOrmAccountRepository = dataSource.getRepository<AccountDao>(AccountDao).extend({
    findOne(props: {
...
export function getTypeOrmAccountRepository(
    manager: AbstractTransactionManager,
): typeof TypeOrmAccountRepository {
